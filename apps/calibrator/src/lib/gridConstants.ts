...
// Portrait phone: 390px wide × ~770px tall → 12 cols × 22 rows.
export const PHONE_WIDTH = 390
export const PHONE_HEIGHT = 770
export const GRID_COLS = 12
export const GRID_ROWS = 22                                // full portrait height
export const CELL_SIZE = Math.floor(PHONE_WIDTH / GRID_COLS) // 32px
...
export const PLAYER_SPAWN_COL = Math.floor(GRID_COLS / 2) // col 6

// Maximum possible wave score: all cells filled with the heaviest entity (shield = 3.0)
export const MAX_WAVE_SCORE = GRID_COLS * GRID_ROWS * 3.0 // 12*22*3 = 792
